...
from app.api.v1.endpoints import auth, analyze, ai_explain, history, curriculum, quiz, benchmarks
...
api_router.include_router(benchmarks.router, prefix="/benchmarks", tags=["Algorithm Comparison Matrix"])
